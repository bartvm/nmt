...
def param_init_fflayer(options, params, prefix='ff', nin=None, nout=None,
    ...
    params[_p(prefix, 'W')] = uniform_weight(nin, nout)
...
def param_init_gru(options, params, prefix='gru', nin=None, dim=None):
    ...
    W = numpy.concatenate([uniform_weight(nin, dim),
...
def param_init_gru_cond(options, params, prefix='gru_cond',
    ...
    Wx = uniform_weight(nin_nonlin, dim_nonlin)
    params[_p(prefix, 'Wx')] = Wx
    ...
    # context to LSTM
    Wc = uniform_weight(dimctx, dim*2)
    params[_p(prefix, 'Wc')] = Wc

    Wcx = uniform_weight(dimctx, dim)
    params[_p(prefix, 'Wcx')] = Wcx

    # attention: combined -> hidden
    W_comb_att = uniform_weight(dim, dimctx)
    params[_p(prefix, 'W_comb_att')] = W_comb_att

    # attention: context -> hidden
    Wc_att = uniform_weight(dimctx,dimctx)
